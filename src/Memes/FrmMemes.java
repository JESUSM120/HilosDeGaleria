...
import javax.swing.*;
import java.awt.*;
public class FrmMemes extends JFrame implements Runnable {
    Thread hilo1;
    ...
    public void run(){
        ...
        while (true){
            ...
            try {
                String nombreImagen = "p" + contadorAdelante + ".png";
                String nombreImagen2 = "p" + contadorAtras + ".png";
                String nombreImagen3  = "p" + (contadorAtras - 2) + ".png";
                picture1 = new ImageIcon(getClass().getResource(nombreImagen));
